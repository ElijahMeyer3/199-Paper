...
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[borderline west={3pt}{0pt}{shadecolor}, enhanced, frame hidden, sharp corners, interior hidden, boxrule=0pt, breakable]}{\end{tcolorbox}}\fi
...
shareable manner through the use of R-studio and GitHub
...
introduced to R, R-studio, and Github. During exploring data, students
...
and are currently in high demand in different data science job
...
not provide these measures, we suggest using \emph{R-studio cloud} (do
we?).

Additionally, prompt feedback on assessments is critical in developing
students understanding of R and R-studio. We have decided to implement a
