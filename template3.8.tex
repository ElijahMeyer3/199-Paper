...
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[enhanced, sharp corners, borderline west={3pt}{0pt}{shadecolor}, boxrule=0pt, breakable, interior hidden, frame hidden]}{\end{tcolorbox}}\fi
...
object to contain the name of original lab repository. In the lab
...
website that is reference during lab time.
...
We can use these new data and change the code found in (??) to create
...
further helps lesson the grading responsibilities to those that are
assigned it.
