...
In the following sections, we describe our specific introductory data
science course, offered to predominantly freshman level students at Duke
University, to provide a flexible ``first-person'' perspective blueprint
for course creation, modernization, and implementation. For more general
information on the leading design principles of this course, please see
the following
\href{https://datasciencebox.org/01-design-principles.html}{here}. For
more information specific to the course content, please refer to the
following paper
...
thinking} (STA199), often has students undecided on their major, but
