...
science course, and the pedagogical decisions to help best equip
students with the data science skills necessary for future classes, so
that instructors can adopt, adapt, and mold these decisions to best fit
their university.
...
foundation of knowledge that sets a stage for each student to not only
...
This model yields five components that are woven into the structure and
assessments of the course. In the initial phase, students are first
introduced to content through assigned readings, videos, and lectures.
During this, students learn through multiple modes of teaching, and
create a foundation of information that they can continue to build upon.
They do this through a hands on \textbf{training} by completing in-class
application exercises. During these exercises, students are given
in-class opportunities to solve problems individually, as a group, and
at the class level. During this time, there is emphasis placed both on
the \textbf{doing}, or steps needed to accomplish the task, as well as
the \textbf{thinking} or training of the brain to accomplish similar
tasks in the future. This culminates into providing assessments that
allow students to show the what they have learned, and connections they
can make through targetted assessments such as homeworks, quizzes,
exams, and project components.

This model is designed to situate the student and guide the instructor
in facilitating an overall quality learning experience. This model
outlines a process performed during a typical week within a semester.
