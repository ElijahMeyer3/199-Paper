...
In this section we will detail the computing infrastructure used to create STA199. This includes details and examples with R, R-studio, and GitHub, from the instructor's perspective, to set up lectures, AEs, labs and homework. First, we start with the necessary student information to collect before creation can take place.
